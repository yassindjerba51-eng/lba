...
import TeamCtaBannerForm from "./TeamCtaBannerForm";
...
export default function TeamPageHeaderForm({ settings: initial, ctaBannerSettings }: Props) {
  ...
  return (
    <>
      ...
      <TeamCtaBannerForm settings={ctaBannerSettings} />
    </>
  );
}
